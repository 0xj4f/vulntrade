...
INSERT INTO flags (flag_name, flag_value, hint) VALUES
    ...
    ('FLAG_LOG4SHELL', 'FLAG{l0g4sh3ll_rc3_tr4d1ng_pl4tf0rm}', 'Exploit Log4Shell CVE-2021-44228 via WebSocket. Inject JNDI payload in admin.haltTrading reason field. Read /opt/flags/flag_log4shell.txt');
